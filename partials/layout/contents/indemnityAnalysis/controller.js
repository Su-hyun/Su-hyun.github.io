...
define(['projectSugar'], function () {
  ...
  indemnityAnalysisModule.controller('indemnityAnalysisController', ['$scope', '$http', '$ocLazyLoad', 'indemnityAnalysisService', 'layoutService',
    function($scope, $http, $ocLazyLoad, indemnityAnalysisService, layoutService) {
